...
<template>
  <Teleport to="body">
    <Transition name="search-palette">
      ...
      >
        <div class="search-palette__card dialog__card conversation-import">
          <header class="dialog__header conversation-import__header">
            <Import :size="14" aria-hidden="true" />
            <span>从 Claude / Codex 导入对话</span>
          </header>
          ...
          <div class="conversation-import__body">
          ...
          <div class="dialog__actions conversation-import__actions">
            <button type="button" class="ghost" :disabled="importing" @click="emit('close')">取消</button>
            <button
              type="button"
              class="primary"
